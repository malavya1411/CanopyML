      ...
      <div className="page-container">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-10">
          <div className="flex items-center gap-3 mb-2">
            <div className="icon-tile h-10 w-10 bg-[#2d8c4e]/20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="space-y-5">
            <div className="surface p-6">
              ...
              <button
                ...
                className="mt-4 flex w-full items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-[#2d8c4e] to-[#00b4a6] py-3 font-semibold text-white transition-all hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-40"
              >
                {isPending ? (
              ...
              {data && (
                ...
                >
                  ...
                  <button
                    ...
                    className="glass flex w-full items-center justify-center gap-2 rounded-lg py-2.5 text-sm font-medium text-[#e6edf3] transition-all hover:border-white/25 disabled:opacity-40"
                  >
                    {reportMut.isPending ? (
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-5">
            ...
            {isPending && (
              <div className="surface flex min-h-72 flex-col items-center justify-center p-10">
